...
public abstract class BaseUnit<UNIT, INTERNAL> implements Comparable<INTERNAL> {
    ...
    @Override
    public int compareTo(INTERNAL value) {
        if (this.value instanceof Comparable) {
            return ((Comparable<INTERNAL>) this.value).compareTo(value);
        }
